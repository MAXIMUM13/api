...
test | object или null | Информация о прикреплённом тестовом задании к вакансии. В случае отсутствия теста — `null`. **В данный момент отклик на вакансии с обязательным тестом через API невозможен**
...
accept_incomplete_resumes | boolean | Разрешён ли отклик на вакансию с неполным резюме
...
Ключ | Тип | Описание
---- | --- | --------
expires_at | string | Дата и время окончания публикации вакансии
response_notifications | boolean или null | Уведомлять ли менеджера о новых откликах
hidden | boolean или null | Удалена ли вакансия (скрыта из архива)
can_upgrade_billing_type | boolean или null | Можно ли улучшить биллинговый тип вакансии
